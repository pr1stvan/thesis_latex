...
\begin{figure}[!htb]
    ...
    \begin{subfigure}[!htb]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vtp_jpg/normal}
        \caption{egyszínű}
    \end{subfigure}
    \hfill
    \begin{subfigure}[!htb]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vtp_jpg/velocity}
        \caption{színezés sebesség szerint}
    \end{subfigure}
    \hfill
    \begin{subfigure}[!htb]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vtp_jpg/vertarea}
...
\begin{figure}[!htb]
    ...
    \begin{subfigure}[!htb]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vtp_jpg/frame1}
        \caption{első frame}
    \end{subfigure}
    \hfill
    \begin{subfigure}[!htb]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vtp_jpg/frame2}
        \caption{második frame}
    \end{subfigure}
    \hfill
    \begin{subfigure}[!htb]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vtp_jpg/frame3}
